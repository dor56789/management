...
# Generate analysis from transcriptions
def generate_analysis(transcript_group, episode_info):
    ...
    for transcript in transcript_group:
        ...
        # key_phrases_list contains: "audio_url", "text", "rank", "start", "end"
...
if __name__ == "__main__":
    episode_urls = ['https://path/to/audio1.mp3', 'https://path/to/audio2.mp3']  # Replace with actual episode URLs
    n_episodes = 2

    transcript_group = generate_keywords_from_audio(episode_urls, n_episodes)
    episode_info = [
        {"audio_url": 'https://path/to/audio1.mp3', "title": "Episode 1", "description": "First episode", "date": "2024-09-12", "episode_length": "30:00"},
        {"audio_url": 'https://path/to/audio2.mp3', "title": "Episode 2", "description": "Second episode", "date": "2024-09-12", "episode_length": "35:00"},
    ]

    analysis = generate_analysis(transcript_group, episode_info)
    print(analysis)
